...
/*   Updated: 2023/04/30 17:01:24 by cmenke           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_pa(t_vars *vars, t_stk **stk_a, t_stk **stk_b)
{
	...
	if ((*stk_b)->future_index > vars->max_stk_a)
		vars->max_stk_a = (*stk_b)->future_index;
	else if ((*stk_b)->future_index < vars->min_stk_a)
		vars->min_stk_a = (*stk_b)->future_index;
	first = (*stk_b)->next;
